/////////////////////////////////////////////////////////////////
//    Sýnislausn á dæmi 5 í heimadæmum 5 í Tölvugrafík
//     Utah tepotturinn litaður með Phong litun.  Örvalyklar
//     færa ljósið til og talnalyklar (1 - 9) breyta nákvæmni
//     tepottsins.
//
...
onload = function init()  {
    ...
    window.addEventListener("keydown", function(e){
        if (e.keyCode >= 37 && e.keyCode <= 40) {
            ...
            var subDiv = e.keyCode - 48;
            myTeapot = teapot(subDiv);
            myTeapot.scale(0.5, 0.5, 0.5);
