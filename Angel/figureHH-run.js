/////////////////////////////////////////////////////////////////
//    Sýnislausn á dæmi 2 í Heimadæmum 5 í Tölvugrafík
...
//     Nú með teningum með mislitum hliðum og fígúran "hleypur".
//
...
//var theta = [0, 0, 180, 0, 180, 0, 0, 0, 0, 0, 0];
...
var render = function() {
    ...
    move = 50.0 * Math.sin(0.005*msek);
    
    // hreyfa handleggi
    theta[leftUpperArmId] = 180.0 + move;
    initNodes(leftUpperArmId);
    theta[rightUpperArmId] = 180.0 - move;
    initNodes(rightUpperArmId);
    
    // hreyfa fótleggi
    theta[leftUpperLegId] = 10.0 - move;
    initNodes(leftUpperLegId);
    theta[rightUpperLegId] = 10.0 + move;
