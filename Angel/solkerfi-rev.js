...
function render()
{
    ...
    mv = mult( scalem( 0.5, 0.5, 0.5 ), mv );
    mv = mult( rotateY(spinY), mv );
    mv = mult( rotateX(spinX), mv );
...
//    mv = mult( mv, scalem( 0.5, 0.5, 0.5 ) );
    ...
    // teikna "jörðina"
    mv = mat4();
    mv = mult( scalem( 0.2, 0.2, 0.2 ), mv );
    mv = mult( rotateY( rotDay ), mv );
    mv = mult( rotateZ( earthTilt ), mv );
    mv = mult( translate( 1.8, 0.0, 0.0 ), mv );
    mv = mult( rotateY( rotYear ), mv );
    mv = mult( scalem( 0.5, 0.5, 0.5 ), mv );
    mv = mult( rotateY(spinY), mv );
    mv = mult( rotateX(spinX), mv );
